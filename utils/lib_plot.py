'''
* This is the script for plottting classification results

* Function draw_action_results is used plot the bounding boxes, tracking IDs 
  and respective actions on the output video
'''
import cv2
import math
import numpy as np
...
# Plot bounding boxes, skeleton tracking id and action class

def draw_action_result(img_display, id, skeleton, str_action_label, ith_img):
